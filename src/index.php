...
<div class="row">
    <div class="col-lg-8">
        ...
        <!-- APIE CAMP Branding Banner -->
        <div class="d-flex align-items-center gap-3 bg-white border rounded px-4 py-3 mb-4 shadow-sm">
            <img src="images/apie-logo.png" alt="APIE CAMP" height="56"
                 onerror="this.style.display='none'">
            <div>
                <h4 class="mb-0 fw-bold" style="color:#c0392b; letter-spacing:2px;">APIE CAMP</h4>
                <span class="text-muted" style="font-size:.9rem;">Cyber Kill Chain Workshop &mdash; Hack the Lab</span>
            </div>
        </div>
