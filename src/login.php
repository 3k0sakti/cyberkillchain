...
<div class="row justify-content-center">
    <div class="col-md-6">
        ...
        <div class="text-center mb-4 mt-3">
            <img src="images/apie-logo.png" alt="APIE CAMP" height="72"
                 onerror="this.style.display='none'">
            <h3 class="fw-bold mt-2" style="color:#c0392b; letter-spacing:2px;">APIE CAMP</h3>
            <p class="text-muted mb-0">Cyber Kill Chain Workshop &mdash; Hack the Lab</p>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-warning">
                    ...
                    <p class="mb-2">The password check still applies with simple OR injections. To fully bypass login, use one of these:</p>
